                        ...
                        <div class="form-row">
                            <div class="col-md-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select name="role" id="role" class="form-control" required>
                                                    ...
                                                    @foreach ($roles as $role)
                                                        <option value="{{ $role->name }}" {{ old('role') }}>
                                                            {{ $role->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                ...
                                <div class="form-row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select name="document_type" id="document_type" class="form-control"
                                                    ...
                                                    <option value="DNI"
                                                        {{ old('document_type') == 'DNI' ? 'selected' : '' }}>
                                                        DNI</option>
                                    ...
                                    <div class="form-group col-md-2 mb-2">
                                        <x-ui.form.date-input name="birthday" label="Fecha de cumpleaños" :value="old('birthday')"
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select name="genre" id="genre" class="form-control" required>
                                                    ...
                                                    <option value="Masculino"
                                                        {{ old('genre') == 'Masculino' ? 'selected' : '' }}>
                                                        Masculino</option>
                                                    <option value="Femenino"
                                                        {{ old('genre') == 'Femenino' ? 'selected' : '' }}>Femenino
                                                    </option>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-3 mb-2">
                                        <x-ui.form.text-input name="contact_relationship" label="Relación o parentesco"
                                            ...
                                            "
                                            required maxlength="255" :value="old('contact_relationship')" />
                                    </div>
